...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    public ProjectDialogScreen(java.awt.Frame parent, boolean modal) {
        ...
        controller = new ProjectController(); //gerencia os dados ao banco de dados
    }
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        //salvar os dados digitados pelo usuário
        try {
            if(!jTextFieldName.getText().equals("")){
                ...
                //fechar a janela após clicar em salvar
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(rootPane, "O projeto não foi salvo, pois o nome não foi preenchido.");
            }
        } catch (Exception e) {
